...
Feature: Class Comparison
  ...
  Scenario: Successful class selection for comparison
    ...
    And I have selected the class "ESS" for comparisson
    And I have selected the class "MD" for comparisson
    And both classes have students enrolled
    When I choose to compare the classes
    Then the "Class Performance Comparisson" pops up
  ...
  Scenario: Unsuccessful comparison attempt due to insufficient number of classes
    Given I am on the "Class" page
    And I have selected only the class "ESS" for comparisson
  ...
  Scenario: Unsuccessful comparison attempt due to missing class data
    Given I am on the "Class" page
    And I have selected the class "ESS" for comparisson
    And I have selected the class "MD2" for comparisson
  ...
  Scenario: Unsuccessful comparison attempt due to exceeding the maximum number of classes
    Given I am on the "Class" page
    And I have selected the class "ESS1" for comparisson
    And I have selected the class "MD2" for comparisson
    And I have selected the class "ESS2" for comparisson
    And I have selected the class "MD23" for comparisson
    And I have selected the class "ESS3" for comparisson
    And I have selected the class "MD22" for comparisson
    When I attempt to select the class "MD3" for comparisson
  ...
  Scenario: Exporting the comparison
    Given I am viewing the "Class Performance Comparisson"
    ...
    And I remain on the "Class Performance Comparisson" view

  Scenario: Successfully adding a class to the comparison
    Given I am on the "Class Performance Comparisson" view
